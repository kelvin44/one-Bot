...
const whatsapplu = 'Wa.me/6285212830930'; // Nomor whatsapplu cok
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] One Bot Ready scan now!`);
});
...
conn.sendMessage(id, 'Author One Bot wa.me/6285212830930' ,MessageType.text);
}
else if (text == 'Kelvin'){
