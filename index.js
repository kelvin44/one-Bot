...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan kode qr lu anjg!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @ff.kelvin15`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @ff.kelvin15`)
})
...
conn.sendMessage(id, 'Owner One Bot nih boss https://wa.me/6285212830930' ,MessageType.text);
}
else if (text == '.creator'){
conn.sendMessage(id, 'creator One Bot nih boss https://wa.me/6285212830930' ,MessageType.text);
}
else if (text == 'Kelvin'){
conn.sendMessage(id, 'Aku BOT nya Kelvin:)' ,MessageType.text);
}
